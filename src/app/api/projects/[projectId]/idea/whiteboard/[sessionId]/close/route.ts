/**
 * POST /idea/whiteboard/[sessionId]/close  — セッション手動クローズ（作成者のみ）
 */
...
import { closeWhiteboardSession } from '@/services/idea-whiteboard.service';
...
export async function POST(
  ...
  let session;
  try {
    session = await closeWhiteboardSession(sessionId, user.id, user.tenantId);
  } catch (e) {
