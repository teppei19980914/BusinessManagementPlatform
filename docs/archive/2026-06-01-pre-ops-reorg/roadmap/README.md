...
- リリースノート: [../archive/2026-06-01-pre-ops-reorg/T-03_RELEASE_NOTES.md](../archive/2026-06-01-pre-ops-reorg/T-03_RELEASE_NOTES.md)
- 改修検証記録: [../archive/2026-06-01-pre-ops-reorg/SUGGESTION_ENGINE_VERIFICATION.md](../archive/2026-06-01-pre-ops-reorg/SUGGESTION_ENGINE_VERIFICATION.md)

## 6/1 リリース前残作業

6/1 リリース前の残作業は公開準備(法的書類・公開ページ)に絞られています。詳細は:

- [../archive/2026-06-01-pre-ops-reorg/PUBLIC_LAUNCH_CHECKLIST.md](../archive/2026-06-01-pre-ops-reorg/PUBLIC_LAUNCH_CHECKLIST.md) — 公開前チェックリスト
- [../archive/2026-06-01-pre-ops-reorg/GO_LIVE_RUNBOOK.md](../archive/2026-06-01-pre-ops-reorg/GO_LIVE_RUNBOOK.md) — 公開当日の時系列手順
