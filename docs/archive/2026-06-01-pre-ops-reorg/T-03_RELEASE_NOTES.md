...
|---|---|---|---|---|
| **内部請求 (本サービス)** | `withMeteredLLM` 越しの呼び出し回数 | プラン別固定単価 (Beginner ¥0 / **Expert ¥10/call** / **Pro ¥15/call**、[ADR-0019](../adr/0019-billable-feature-units-and-free-tier-expansion.md) / 2026-05-24 改定後) | 呼び出し成功直後にアトミック increment | `Tenant.currentMonthApiCostJpy` + `ApiCallLog` |
