...
未追跡で残置中 (PR-A に含めず):
- `docs/operations/operate/MAINTENANCE_OPERATIONS.md` (運用カタログ doc、ADR-0021 無関係)
...
| ファイル | 内容 |
|---|---|
| `docs/operations/setup/SUPABASE_STORAGE_SETUP.md` | Bucket 作成手順 + RLS Policy SQL + CORS |
...
- (新規) `docs/operations/setup/SUPABASE_STORAGE_SETUP.md`
...
- (未追跡) `docs/operations/operate/MAINTENANCE_OPERATIONS.md` (本セッション前に作成済)
...
### 5. RLS Policy
- `docs/operations/setup/SUPABASE_STORAGE_SETUP.md` に SQL は記載済だが、実際の Supabase project には **未適用** (P14 ユーザ作業)
