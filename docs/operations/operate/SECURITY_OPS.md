...
本アプリの多層防御実装の詳細は [`docs/design/SECURITY.md`](../../design/SECURITY.md) を参照。本節は **運用担当 (管理者) が日常業務で実施する確認手順** に絞る。
...
- `CI_TRIGGER_PAT` — CI 自動再起動用 PAT (PR #121、[MAINTENANCE_OPERATIONS §1.5.1](./MAINTENANCE_OPERATIONS.md) 参照、期限管理必須)
