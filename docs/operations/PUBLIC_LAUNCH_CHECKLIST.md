...
- [x] **スケルトンページ配置**: `src/app/(public)/terms/page.tsx`(2026-05-19)
  - 「ドラフト版 - 法務監修待ち」バナー表示
  - 含めるべきセクション (1-9) を可視化
  - フッタリンクから到達可能(`/terms` 未認証アクセス OK、`PUBLIC_PATHS` 登録済)
- [ ] **正式な本文への差し替え**(法務監修必須):
...
- [x] **スケルトンページ配置**: `src/app/(public)/privacy/page.tsx`(2026-05-19)
  - 「ドラフト版 - 法務監修待ち」バナー表示
  - 含めるべきセクション (1-9) を可視化
  - フッタリンクから到達可能(`/privacy` 未認証アクセス OK、`PUBLIC_PATHS` 登録済)
- [ ] **正式な本文への差し替え**(法務監修必須):
