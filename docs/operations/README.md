...
| [DEPLOYMENT.md](./DEPLOYMENT.md) | Netlify 本番デプロイ手順 | OPERATION.md §5 |
...
| [CRON.md](./CRON.md) | 外部 cron (cron-job.org) スケジュール + ヘルスチェック + 死活監視 | OPERATION.md §8-§11 |
...
| [MIGRATION_TO_AWS.md](./MIGRATION_TO_AWS.md) | Netlify + Supabase から AWS / Azure / GCP への将来的移行計画 | DESIGN.md §34.13 |
...
| [BACKUP_VERIFICATION.md](./BACKUP_VERIFICATION.md) | バックアップ検証手順 (四半期 + 臨時、Supabase/Netlify/Storage/環境変数の復元可能性確認) | 新規 (2026-05-16) |
