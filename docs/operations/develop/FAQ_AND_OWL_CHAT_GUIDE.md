...
を選び分けてください。判断に迷ったら ADR-0019 と ADR-0027 を読み比べて、課金分類 4 階層 (LLM / EMBEDDING / STORAGE_OVERAGE / BACKFILL_FREE) のどれに該当するかを確認してください (memory: 課金 4 階層分類 feedback_billing_4layer_classification.md)。
...
`docs/design/OBSERVABILITY.md` の help-chat 監視項目を参照。
...
- **運用監視**: [OBSERVABILITY.md](../../design/OBSERVABILITY.md) — help-chat 利用量監視
