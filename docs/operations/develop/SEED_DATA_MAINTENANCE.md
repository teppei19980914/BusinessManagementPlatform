...
詳細手順は [DB_MIGRATION_PROCEDURE.md §3.3.2](./DB_MIGRATION_PROCEDURE.md) を参照。
...
| ドキュメント | 内容 |
|---|---|
| [V1_FINAL_TASKS.md](../../archive/roadmap/V1_FINAL_TASKS.md) | PR-X5 / PR-X6 の計画 (シードデータ拡充 + 段階表示 UI) |
| [SUGGESTION_ENGINE_PLAN.md](../../archive/roadmap/SUGGESTION_ENGINE_PLAN.md) | 提案エンジン v2 の全体計画 |
| [SUGGESTION_ENGINE.md](../../design/SUGGESTION_ENGINE.md) | 提案エンジン技術設計 (embedding / scoring 仕様) |
| [SUGGESTION_ENGINE_VERIFICATION.md](../../archive/2026-06-01-pre-ops-reorg/SUGGESTION_ENGINE_VERIFICATION.md) | 改修効果の検証記録 (before/after) |
| [DB_MIGRATION_PROCEDURE.md](./DB_MIGRATION_PROCEDURE.md) | DB マイグレーション・接続情報設定手順 |
