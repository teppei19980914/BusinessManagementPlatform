...
| 法的書類見直し | 利用規約 / プライバシーポリシー / 特定商取引法表示の改訂要否確認 | [PUBLIC_LAUNCH_CHECKLIST.md](./PUBLIC_LAUNCH_CHECKLIST.md) |
...
| リリース実施 (バージョン更新) | リリース手順 | (計画的) | 1〜2 時間 | [RELEASE_PROCEDURE.md](./RELEASE_PROCEDURE.md) / [GO_LIVE_RUNBOOK.md](./GO_LIVE_RUNBOOK.md) |
