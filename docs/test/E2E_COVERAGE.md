...
- [ ] `/api/admin/super/billing/[id]/confirm-payment` (POST) — skip: PR-V7a (2026-05-19) 銀行振込手動消込。invoice/bank_transfer の pending → paid 遷移 + AuditLog 記録。credit_card は拒否。サービス層 (src/services/billing-management.service.test.ts 6 件) で担保
