...
## 3. 利用規約への組み込み (2026-05-21 / feat/legal-pages-lp-integration で反映済)

本文書のルールは [利用規約 v1.0](https://teppei19980914.github.io/HomePage/ja/product/tasukiba-user/#terms) (HomePage repo の `tasukiba-user.md` `#terms`) に **既に反映済** です。対応関係:

| 本書のルール | 利用規約の対応条項 |
|---|---|
| §1 支払い期日と請求サイクル | 第 8 条 (支払方法・締日・支払期限) |
| §2.2-2.5 滞納フェーズ (read-only / 削除) | 第 9 条 (滞納時の措置) + 第 15 条 (当社による契約解除) |
| §2.5 データ削除 (30 日 / 14 日猶予) | 第 14 条 (ユーザによる解約) + 第 16 条 (データの取扱い) |
| 支払い遅延損害金 (当面 0%) | 第 8 条 5 項 (= 将来導入時は第 24 条の手続で 30 日以上前に通知) |
