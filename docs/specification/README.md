...
| 旧パス | 現在の場所 | 移動日・経緯 |
|---|---|---|
| docs/specification/CHAT_SEMANTIC_SEARCH.md | [../roadmap/future/CHAT_SEMANTIC_SEARCH.md](../roadmap/future/CHAT_SEMANTIC_SEARCH.md) | 2026-05-17 移動: v1.0 対象外で v2 以降の機能のため |
