...
| P-5: 月次運用ダッシュボード自動化 | 📝 未着手 | - | 着手予定 |
| P-6: 最終ログイン日時 + 休眠警告 | 📝 未着手 | - | テナント数 5+ になったら検討 |
| P-7: 請求書 PDF 自動生成 | 📝 未着手 | - | テナント数 20+ になったら検討 |
...
P-3 提案説明文生成 (PR #258) ✅ 完了
   ↓
P-4 提案リランキング ⏸️ 見送り (P-1 + P-3 で十分と判断)
   ↓
P-5 月次運用ダッシュボード自動化 (2-3 日) ← 次着手予定
   ↓
P-6/P-7 (テナント数次第)
```

実績工数: P-1〜P-3 で **約 4-5 日相当**。P-4 見送りで残工数は **5-8 日** (P-5/P-6/P-7、需要ベース)。
