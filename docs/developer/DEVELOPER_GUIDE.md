...
| 2026-04-24 | §10.5 再発事例 5 / 6 例目 (PR #132 / #133 hotfix)。stacked 4 段目 / 5 段目。5 PR 連続再発を根拠として運用ルールを確定: (1) base hotfix は即座に全 sub-PR へ順送り merge、(2) 4 段超では自動化スクリプト整備が必要、(3) sub-PR 作成時点で base 最新 HEAD に rebase しておくと伝播コスト削減 |
