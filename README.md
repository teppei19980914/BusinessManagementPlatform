...
| チャット意味検索 | 全画面右下の「たすきフクロウ」アイコンから自然文で過去資産 (Project / Knowledge / Risk / Issue / Retrospective / Memo / 添付ファイル) を横断検索。LINE/Teams 風吹き出し UI で対話形式に提案を返す ([使い方ガイド](./docs/public/chat-semantic-search-guide.md)) |
