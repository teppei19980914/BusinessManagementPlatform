...
| `20260419_project_process_tags_and_suggestion` | projects.process_tags 追加 + pg_trgm 拡張有効化 + knowledges / risks_issues のトライグラム GIN インデックス (核心機能「提案型サービス」, DESIGN.md §23) | #65 |
